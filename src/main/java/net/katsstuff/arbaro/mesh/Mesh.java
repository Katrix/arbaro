...
/**
 * A class for creation, handling and output of a mesh object. A Mesh consists of MeshParts which are tube like objects,
...
public class Mesh extends java.util.Vector {
	...
	private class VertexEnumerator implements Enumeration {
		...
		private final Enumeration parts;
...
//			System.err.println("next part "+part.stem.getTreePosition());
	...
	/**
	 * Returns the total number of faces, that has to be created for the mesh. Povray wants to know this before the
	 * faces itself.
	 *
	...
	/**
	 * Returns the total number of uv-vectors, that has to be created for the mesh. Povray wants to know this before the
	 * uv vectors itself.
	 *
