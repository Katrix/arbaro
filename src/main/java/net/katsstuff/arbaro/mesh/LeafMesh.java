...
class SphereShape extends LeafShape {
	...
	public SphereShape(double len, double wid, double stem_len) {
		...
		faces[0] = new Face(0, 1, 6);
		faces[1] = new Face(0, 6, 4);
		faces[2] = new Face(1, 8, 7);
		faces[3] = new Face(1, 7, 11);
		faces[4] = new Face(2, 3, 0);
		faces[5] = new Face(2, 3, 8);

		faces[6] = new Face(3, 9, 7);
		faces[7] = new Face(3, 10, 9);
		faces[8] = new Face(4, 10, 2);
		faces[9] = new Face(4, 5, 10);
		faces[10] = new Face(5, 6, 11);
		faces[11] = new Face(5, 11, 9);

		faces[12] = new Face(0, 8, 1);
		faces[13] = new Face(6, 1, 11);
		faces[14] = new Face(6, 5, 4);
		faces[15] = new Face(0, 4, 2);

		faces[16] = new Face(7, 8, 3);
		faces[17] = new Face(10, 3, 2);
 ...
 * located at the origin. To create a leaf at it's position, you have to apply the leafs transformation to the leaf mesh
 * points.
 *
 * @author wdiestel
 */
