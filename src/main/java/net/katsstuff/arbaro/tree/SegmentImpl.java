...
class SegmentImpl implements StemSection {
	...
	/* (non-Javadoc)
	 * @see net.katsstuff.arbaro.tree.TraversableSegment#getLength()
	 */
	...
	/* (non-Javadoc)
	 * @see net.katsstuff.arbaro.tree.TraversableSegment#getTransformation()
	 */
	...
	/**
	 * Make a subsegments for a segment with spherical end (last stem segment), subsegment lengths decrements near the
	 * end to get a smooth surface
	 *
	 * @param cnt the number of subsegments
	 */
	...
	/**
	 * Make subsegments for a segment with flare (first trunk segment). Subsegment lengths are decrementing near the
	 * base of teh segment to get a smooth surface
	 *
	 * @param cnt the number of subsegments
	 */
	...
	/**
	 * Make subsegments for a segment with helical curving. They curve around with 360° from base to top of the segment
	 *
	 * @param cnt the number of subsegments, should be higher when a smooth curve is needed.
	 */
	 ...
	 * stems, because the substems doesn't grow from the axis of the segement
	 *
	 * @param trf the transformation of the substem
	 * @param where the offset, where the substem spreads out
	 * @return the new transformation of the substem (shifted from the axis of the segment to the axis of the
	 * 	subsegment)
	 */
	...
	/* (non-Javadoc)
	 * @see net.katsstuff.arbaro.tree.TraversableSegment#isLastStemSegment()
	 */
