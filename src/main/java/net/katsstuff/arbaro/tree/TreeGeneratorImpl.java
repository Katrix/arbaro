...
class TreeGeneratorImpl implements TreeGenerator {
	...
	/* (non-Javadoc)
	 * @see net.katsstuff.arbaro.tree.TreeGenerator#makeTree(net.katsstuff.arbaro.export.Progress)
	 */
	...
	/* (non-Javadoc)
	 * @see net.katsstuff.arbaro.tree.TreeGenerator#setSeed(int)
	 */
	...
	// class
	/* (non-Javadoc)
	 * @see net.katsstuff.arbaro.tree.TreeGenerator#getParam(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see net.katsstuff.arbaro.tree.TreeGenerator#writeParamsToXML(java.io.PrintWriter)
	 */
	// TODO: not used at the moment, may be the GUI
	// should get a TreeGenerator as a ParamContainer
	// and tree maker, and not work directly with Params
