...
/**
 * A tree used to preview the edited tree, it draws the stems and leaves with lines to Graphics context and modifies the
 * level and branching parameters to calculate and draw only parts of the tree, reducing calculation time as well.
 *
 * @author wdiestel
 */
...
//	TreeGenerator treeGenerator;
	 ...
	 */
	public PreviewTree(
		Params params/*, MeshGenerator meshGenerator,
			TreeGenerator treeGenerator*/
	) {
...
//		this.treeGenerator = treeGenerator;
	...
	public Vector getMaxPoint() {
		return tree.getMaxPoint();
	}

	public Vector getMinPoint() {
		return tree.getMinPoint();
	}
	...
	public String getLeafShape() {
		return tree.getLeafShape();
	}

	public double getLeafWidth() {
		return tree.getLeafWidth();
	}

	public double getLeafLength() {
		return tree.getLeafLength();
	}
