...
class POVConeLeafWriter implements TreeTraversal {
	...
	/* (non-Javadoc)
	 * @see net.katsstuff.arbaro.tree.TreeTraversal#enterStem(net.katsstuff.arbaro.tree.Stem)
	 */
	...
	/* (non-Javadoc)
	 * @see net.katsstuff.arbaro.tree.TreeTraversal#leaveStem(net.katsstuff.arbaro.tree.Stem)
	 */
	...
	/* (non-Javadoc)
	 * @see net.katsstuff.arbaro.tree.TreeTraversal#leaveTree(net.katsstuff.arbaro.tree.Tree)
	 */
	...
	/* (non-Javadoc)
	 * @see net.katsstuff.arbaro.tree.TreeTraversal#visitLeaf(net.katsstuff.arbaro.tree.Leaf)
	 */
